...
import React, { DetailedHTMLProps, ReactNode, Ref, TextareaHTMLAttributes, forwardRef } from 'react'
        ...
        <div className={clsx(`input-wrap` , wrapperClassName)}>
            ...
            {showLength && (
                <div className='flex flex-row justify-end text-[#999999]'>
                    (
                        <span className='text-primary'>{formatNumber((value as string)?.length || 0)}</span>
