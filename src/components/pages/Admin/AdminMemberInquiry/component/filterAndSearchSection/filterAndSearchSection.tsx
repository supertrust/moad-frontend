            ...
            <div className={styles['filter-body']}>
                <div className={'flex items-center'}>
                    <div className={styles['filter-label']}>
                        <span className={styles['filter-key']}>가입일</span>
                    </div>
                ...
                <div className={clsx(styles['border-top'],'flex items-center')}>
                    <div className={styles['filter-label']}>
                        <span className={styles['filter-key']}>회원상태</span>
                    </div>
                    <div className={'flex space-x-[10px] pl-5'}>
                        {
                            memberStatusFilter.map( (obj,key)=>{
                                return <Checkbox key={key} onChange={onChange}>{obj.label}</Checkbox>;
                            })
                        }
                    </div>
                </div>
