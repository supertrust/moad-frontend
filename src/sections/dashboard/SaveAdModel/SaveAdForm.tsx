                    ...
                    <div className={styles.modal_step}>
                        ...
                        <div className={styles.price_section}>
                            <div className={`${styles.price_box} ${styles.spot_add}`}>
                                <div className={`${styles.price_text} !text-[#222222] border-solid border-r-[1px] border-[#EBEDF4] p-[16px]`}>광고비용</div>
                                <div id="total_price" className={`${styles.price_text} ${styles.total_price} !text-[#2F48D1]`}>{totalPrice ? totalPrice.toLocaleString() : null}</div>
                                <div className={`${styles.price_text} ${styles.text_won} !text-[#999999]`}>원</div>
                            </div>
