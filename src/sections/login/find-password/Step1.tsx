...
type Step1Props = {
    step: number;
    onCheckUserSuccess: (string) => void;
    onClose: () => void;
    onFindId: () => void;
}
...
const Step1 = ({step, onCheckUserSuccess, onClose, onFindId}: Step1Props) => {
    ...
    return (
        <div id="step01_modal" className={`${styles.step01_modal} ${styles.model_wrap} ${step === 1 ? styles.active : null}`}>
