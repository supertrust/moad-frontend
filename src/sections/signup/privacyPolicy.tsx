...
function PrivacyPolicy() {
  ...
  return (
    ...
    <>
      <p className="c9">
        <span className="c37">
          ㈜모아드(이하 “회사”)는 회사가 운영하는 인터넷 사이트(
        </span>
        <span className="c33">홈페이지 URL</span>
        <span className="c5">
          이하 “모아드”)를 이용하는 이용자님들의 개인정보를 매우 중요하게 생각하며
          아래와 같은 개인정보처리방침을 가지고 있습니다. 이 개인정보처리방침은
          개인정보와 관련한 법령 또는 지침의 변경이 있는 경우 갱신되고, 정책의
          변화에 따라 달라질 수 있으니 이용자께서는 모아드 마케팅 플랫폼 사이트를
          방문 시 수시로 확인하여 주시기 바랍니다. 모아드 마케팅 플랫폼의
      ...
      <ol className="c2 lst-kix_awxmkbtjh40q-0 start" start={1}>
        ...
        <li className="c10 li-bullet-0">
          <span className="c5">
            나. 이용자는 언제든지 모아드 마케팅 플랫폼 사이트의 개인정보에 대하여
