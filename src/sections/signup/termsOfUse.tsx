...
function TermsOfUse() {
  return (
    <>
      ...
      <p className="c1">
        <span className="c0">
          본 약관은 ㈜이카루스(이하 "회사")가 제공하는 광고 서비스(아래 정의)를
      ...
      <ol className="c4 lst-kix_bwulzs2i1l18-0 start" start={1}>
        ...
        <li className="c3 li-bullet-0">
          <span>
            ⑥ "이카루스 광고센터"라 함은 "광고주"의 광고 신청, 게재, 관리, 취소 등을
      ...
      <ol className="c4 lst-kix_9lbtd2o11732-0 start" start={1}>
        <li className="c3 li-bullet-0">
          <span>
            ① "회사"는 본 약관의 내용을 "광고주"가 쉽게 알 수 있도록 "이카루스(
          </span>
          <span className="c9">홈페이지 URL</span>
      ...
      <ol className="c4 lst-kix_gcnk1726ag0y-0 start" start={1}>
        <li className="c3 li-bullet-0">
          ...
          <span className="c0">
            &nbsp;) 및 "이카루스 광고센터" 에 공지하며 "광고주"는 광고 신청 전에
            이를 신중히 확인하여야 합니다.
          </span>
        </li>
        <li className="c3 li-bullet-0">
      ...
      <ol className="c4 lst-kix_gcnk1726ag0y-0" start={5}>
        <li className="c3 li-bullet-0">
          <span className="c0">
            ⑤ "광고주"는 "회사"가 정한 절차와 방식에 따라 언제든지 "이카루스"에
      ...
      <ol className="c4 lst-kix_6ube3zqa3pt2-0 start" start={1}>
        ...
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            "이카루스"내 게시판에 공지합니다. "광고주"는 "광고 서비스"의 변경 내용에
            동의하지 않을 경우 언제든지 "이카루스"내에서 "광고"의 노출을 중단할 수
            있습니다.
          </span>
        </li>
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            최소 7일 전에 이카루스 공지사항란을 통해 테스트 진행 내용을 별도
            공지합니다.
          </span>
        </li>
      </ol>
      ...
      <ol className="c4 lst-kix_6ube3zqa3pt2-0" start={4}>
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            서비스 중단의 경우 "회사"는 이카루스 광고센터 메인, 공지사항 게시판이나
      ...
      <ol className="c4 lst-kix_9z7ttbbevln3-0 start" start={1}>
        ...
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            세금계산서를 발행하며 "광고주"는 해당 세금계산서를 "이카루스"를 통하여
            출력할 수 있습니다.
          </span>
        </li>
        <li className="c3 li-bullet-0">
      ...
      <ol className="c4 lst-kix_jvq872n28gbj-0 start" start={1}>
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            별도의 규정이 없는 한 "광고주"가 "이카루스 광고센터"에 제공한
            전자우편주소, (휴대)전화번호, 주소 중 하나로 통지하거나, 통지에 갈음하여
            "광고주"의 "이카루스 광고센터" 로그인시 알림창 등의 수단으로 할 수
            있습니다.
          </span>
        </li>
        <li className="c3 li-bullet-0">
      ...
      <ol className="c4 lst-kix_1if9dzlexiok-0 start" start={1}>
        <li className="c3 li-bullet-0">
          <span className="c0">
            ① "광고주"는 언제든지 "이카루스 광고센터"에 접속하여 "광고" 이용계약을
            해지할 수 있습니다.
          </span>
        </li>
        <li className="c3 li-bullet-0">
      ...
      <ol className="c4 lst-kix_1if9dzlexiok-1 start" start={1}>
        <li className="c6 li-bullet-0">
          <span className="c0">
            1) "광고주"가 이카루스 회원 자격을 상실하거나 정지된 경우
          </span>
        </li>
        <li className="c6 li-bullet-0">
          <span className="c0">
      ...
      <ol className="c4 lst-kix_jryf0al0udev-0 start" start={1}>
        ...
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            정당하다고 인정될 경우 이를 처리하여야 하며 "이카루스 광고센터" 내
      ...
      <ol className="c4 lst-kix_n291az369z9f-0 start" start={1}>
        ...
        <li className="c3 li-bullet-0">
          <span className="c0">
            ② "회사"의 원활한 서비스 제공을 위하여 "광고주"는 이카루스 광고센터에
        ...
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            한해 "이카루스 광고센터"에 게시된 대행사 중 "광고주"가 지정한
            대행사("광고대행사")에게 "이카루스 광고센터" 및 관련 시스템 이용 권한을
            부여할 수 있으며 "광고대행사"에 대한 감독책임은 "광고주"에게 귀속됩니다.
            "광고주"가 "광고대행사"를 지정하면 해당 지정의 효과는 "회사"가 "이카루스
        ...
        <li className="c3 li-bullet-0">
          <span className="c0">
            ...
            지정한 "광고대행사"의 이카루스 ID 계정 이용을 취소하며 "광고주"가 직접
            광고 업무를 수행하는 것으로 변경합니다. 단, 이카루스 ID 계정 이용 해지
